...
command -v pip3 >/dev/null 2>&1 && sudo pip3 install -r requirements.txt || { echo >&2 "pip3 not installed, trying pip";}
command -v pip >/dev/null 2>&1 && sudo pip install -r requirements.txt || { echo >&2 "pip not installed, you must have pip or pip3!";}
